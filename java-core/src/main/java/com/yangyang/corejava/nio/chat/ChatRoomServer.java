package com.yangyang.corejava.nio.chat;
...
public class ChatRoomServer {
	...
	public void init() throws IOException {
		...
		while (true) {
			...
			Iterator keyIterator = selector.selectedKeys().iterator(); // 可以通过这个方法，知道可用通道的集合
	...
	public void dealWithSelectionKey(ServerSocketChannel server, SelectionKey key) throws IOException {
		if (key.isAcceptable()) {//客户端请求事件
