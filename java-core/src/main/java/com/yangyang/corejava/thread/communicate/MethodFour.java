...
public class MethodFour {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        Helper.executor.submit(four.newThreadOne());
        Helper.executor.submit(four.newThreadTwo());
        Thread.sleep(2000);
        System.out.println("");
        Helper.executor.submit(four.newThreadThree());
        Helper.executor.submit(four.newThreadFour());
